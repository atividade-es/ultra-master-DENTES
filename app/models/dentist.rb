class Dentist < ApplicationRecord
  ...
  validates :horario_chegada, presence: true, inclusion: { in: (Time.parse("06:00")..Time.parse("16:00")) }
  validates :horario_saida, presence: true, inclusion: { in: (Time.parse("12:00")..Time.parse("22:00")) }
