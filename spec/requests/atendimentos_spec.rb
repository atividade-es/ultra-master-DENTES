  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Atendimento" do
        expect {
          post atendimentos_url, params: { atendimento: valid_attributes }
        }.to change(Atendimento, :count).by(1)
      end

      it "redirects to the created atendimento" do
        post atendimentos_url, params: { atendimento: valid_attributes }
        expect(response).to redirect_to(atendimento_url(Atendimento.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new Atendimento" do
        expect {
          post atendimentos_url, params: { atendimento: invalid_attributes }
        }.to change(Atendimento, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested atendimento" do
        atendimento = Atendimento.create! valid_attributes
        patch atendimento_url(atendimento), params: { atendimento: new_attributes }
        atendimento.reload
      ...
      it "redirects to the atendimento" do
        ...
        patch atendimento_url(atendimento), params: { atendimento: new_attributes }
        atendimento.reload
        expect(response).to redirect_to(atendimento_url(atendimento))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        atendimento = Atendimento.create! valid_attributes
        patch atendimento_url(atendimento), params: { atendimento: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
